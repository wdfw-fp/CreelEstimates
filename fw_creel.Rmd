...
if(nchar(params$dir_output) > 1) {
  ...
  path = file.path(paste(here(), params$dir_output, params$project, paste(params$fishery_name, params$est_date_start, params$est_date_end, sep = "_"), sep = "/"), paste0("dwg_fetch_summary_", params$fishery_name, params$est_date_start, params$est_date_end, ".xlsx"))
  )
}
...
if(nchar(params$dir_output) > 1) {
  ...
  path = file.path(params$dir_output, params$project, paste(params$fishery_name, params$est_date_start, params$est_date_end, sep = "_"), paste0("pe_output_", params$fishery_name, params$est_date_start, params$est_date_end, ".xlsx"))
  )
}
...
if(nchar(params$dir_output) > 1) {
  ...
  path = file.path(params$dir_output, params$project, paste(params$fishery_name, params$est_date_start, params$est_date_end, sep = "_"), paste0("bss_overview_", params$fishery_name, params$est_date_start, params$est_date_end, ".xlsx"))
  )
}
```
