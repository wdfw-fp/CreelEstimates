...
params:
  ...
  est_catch_groups: !r data.frame(rbind(
    ...
    c(species = 'Coho', life_stage = 'Adult', fin_mark = 'AD', fate = 'Released'),
    c(species = 'Chinook', life_stage = 'Adult|NA|UNK', fin_mark = 'UM|AD|UNK|NA', fate = 'Released'),
    c(species = 'Chum', life_stage = 'Adult|NA', fin_mark = 'UM|NA|UNK', fate = 'Released')
    ))
...
if(nchar(params$dir_output) > 1) {
  writexl::write_xlsx(
  c(estimates_pe[rev(names(estimates_pe))], set_names(dwg, paste0("dwg_", names(dwg)))),
  path = file.path(params$dir_output, paste0(params$fishery_name, params$est_date_start, params$est_date_end, ".xlsx"))
  )
}
