...
params:
  ...
  output_teams_name: "DFW-Team FW Creel Monitoring Program - General/Analysis"
output:
  html_document:
    fig_caption: yes
    theme: default
...
wd_output <- if_else(params$output_location_filepath == "local", paste0(local_path, "/project_outputs"), paste0("T:/", params$output_teams_name)) # uses params$output_location_filepath to route outputs to either a local storage location (project_outputs) or network drive location (Teams folder)
