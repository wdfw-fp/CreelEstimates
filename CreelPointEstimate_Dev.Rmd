...
params:
  ...
  model_period: "Week"
  sections: "sections_d13_skykomish_summer_chin.csv"
output:
  html_document:
    fig_caption: yes
    theme: default
...
lut <- map(
  list(
    ...
    census_expansion = "input_files/ti_expansions_d13_skykomish_summer_chin.csv" 
  ),
...
d_days <- rows_upsert(d_days,
    bind_rows(
      ...
      tibble(section = "1", closure_begin = "2021-05-28", closure_end = "2021-05-28")
...
estimates$cpue_time_strata |> 
  ...
  filter(catch_group %in% c( "Chinook_Adult_AD_Kept")) |>
