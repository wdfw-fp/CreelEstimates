...
#     sum = sum(fish_count)
#   )
# pivot_long to make calculations using fish count data
...
point_estimate_data_prelim$interview_daily_totals_total <- point_estimate_data_prelim$interview_and_catch |>
  ...
  summarise(
    ...
    cpue_mor = mean(cpue_interview) / n_groups  # mean of ratios CPUE estimator
  ) |>
  mutate(
...
# test <- point_estimate_data_prelim$interview_daily_totals |>
#   ungroup() |> 
...
point_estimate_data_prelim$daily_CPUE <- point_estimate_data_prelim$interview_daily_totals_complete |> 
  ...
  select(section, time_strata, event_date, angler_type, catch_group, catch_dailysum, cpue_rom, cpue_mor, mean_strata_cpue_rom)
