...
point_estimate_data_prelim$interview <- point_estimate_data_prelim$interview |> 
  ...
  mutate(
    ...
    angler_type = case_when( # 3/31/2022 discuss with KB, TB, AE about angler type classification standards
      boat_used == "Yes" ~ "boat",
      boat_used == "No" ~ "bank",
      # is.na(fish_from_boat) ~ "bank",
      # fish_from_boat == "Bank" ~ "bank",
...
point_estimate_data_prelim$interviews_total_effort <- point_estimate_data_prelim$interview |> 
  group_by(section, DayL, event_date, day_index, time_strata) |> 
  summarize(
    daily_sum_angler = sum(angler_count),
...
days_join <- d_days |> 
  ...
  mutate(
    time_strata = if_else(ModelPeriod == "Month", Month, Week),
    at_1 = "total", at_2 = "bank", at_3 = "boat"
  ) |> 
