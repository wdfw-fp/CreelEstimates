...
params:
  ...
  est_catch_groups: !r data.frame(rbind(
    c(species = 'Chinook', life_stage = 'Jack', fin_mark = 'AD', fate = 'Released')))
...
## 4/25/2024 check to ensure that angler_count is the field we want to use (vs. total group count), check and see what field is being used in the prep_bss_inputs function !!
