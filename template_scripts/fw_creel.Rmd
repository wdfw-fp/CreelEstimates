...
params:
  ...
  fishery_name: "Skagit spring Chinook 2026 lower"
  est_date_start: "2026-04-20"
  est_date_end: "2026-05-03"
  est_catch_groups: !r data.frame(rbind(
    c(species = 'Chinook', life_stage = 'Adult', fin_mark = 'UM', fate = 'Released'),
    c(species = 'Bull Trout|Dolly Varden', life_stage = 'NA', fin_mark = 'NA', fate = 'Released'),
