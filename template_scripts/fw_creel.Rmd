...
knitr::opts_chunk$set(
  # echo = FALSE,           # Hide code by default (you have code_folding anyway)
  warning = FALSE,
  message = FALSE,
  cache = FALSE,          # Default to no caching (opt-in per chunk)
  fig.width = 10,
  fig.height = 8,
  fig.path = "figures/",  # Store figures in organized folder
  cache.path = "cache/"   # Store cache in organized folder
)
...
```{r summary_and_convergence, cache=TRUE, dependson="estimates_bss", results='hide'}
