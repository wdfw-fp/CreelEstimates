...
params:
  ...
  fishery_name: "Skagit winter gamefish 2022-23"
  est_date_start: "2022-12-01"
  est_date_end: "2023-01-31"
  est_catch_groups: !r data.frame(rbind(
    c(species = 'Steelhead', life_stage = 'Adult|UNK|NA', fin_mark = 'UM|UNK|NA', fate = 'Released')
...
inputs_pe$census_expan <- prep_inputs_pe_census_expan(int = dwg$interview, census_expansion = params$census_expansion)
