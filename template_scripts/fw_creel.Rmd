...
params:
  ...
  fishery_name: "Skagit spring Chinook 2021 upper"
  est_date_start: "2021-06-01"
  est_date_end: "2021-07-15"
  est_catch_groups: !r data.frame(rbind(
    ...
    c(species = 'Bull Trout|Dolly Varden', life_stage = 'Adult|UNK|NA', fin_mark = 'UM|NA|UNK', fate = 'Released'),
    c(species = 'Bull Trout|Dolly Varden', life_stage = 'Adult|UNK|NA', fin_mark = 'UM|NA|UNK', fate = 'Kept')
    ))
