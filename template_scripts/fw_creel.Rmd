...
# create the project_outputs folder 
ifelse(!dir.exists(paste(here::here(), "project_outputs", sep = "/")),
       {dir.create(paste(here::here(), "project_outputs", sep = "/")); "project_outputs sub-folder created"},
       "project_outputs sub-folder exists already")
...
ifelse(!dir.exists(paste(wd_output, params$project_name, sep = "/")),
       {dir.create(paste(wd_output, params$project_name, sep = "/")); "project_outputs/project_name sub-folder created"},
       "project_outputs/project_name sub-folder exists already")

analysis_name <- paste(params$fishery_name, params$est_date_start, params$est_date_end, sep = "_")

ifelse(!dir.exists(paste(wd_output, params$project_name, params$fishery_name, sep = "/")),
       {dir.create(paste(wd_output, params$project_name, params$fishery_name, sep = "/")); "project_outputs/project_name/fishery_name analysis sub-folder created"},
       "project_outputs/project_name/fishery_name analysis sub-folder exists already")
