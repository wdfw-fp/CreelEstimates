...
params:
  ...
  est_catch_groups: !r data.frame(rbind(
    c(species = 'Coho', life_stage = 'Adult', fin_mark = 'AD|UM', fate = 'Kept'),
    c(species = 'Chinook', life_stage = 'Adult', fin_mark = 'AD|UM', fate = 'Released'),
    c(species = 'Bull Trout', life_stage = 'Adult', fin_mark = 'AD|UM', fate = 'Released')
    ))
...
```{r fig.cap= "Estimated catch per unit effort (fish / hour) grouped by catch group, time strata, section, and angler type."}
...
```{r plot_pe_catch_estimates, fig.cap= "Catch estimates for each fish catch group, grouped by time strata, section, and angler type (angler_final)."}
# barplot of catch estimates by catch group, time stratum, section, and angler type
# plot_est_pe_catch(
#   estimates_pe_catch = estimates_pe$catch,
#   est_catch_group = "Chinook_Adult_AD|UM_Released")
