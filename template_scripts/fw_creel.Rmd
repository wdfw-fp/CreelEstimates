...
# creelutils::get_hmc_diagnostics(stan_fit = ecg_fit)
...
if (exists("creel_estimates")) {
  ...
  save(creel_estimates, file = paste0(file.path(here(), params$project_name, params$fishery_name, "creel_estimates.rda")))
