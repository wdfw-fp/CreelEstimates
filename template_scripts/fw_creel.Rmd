...
params:
  ...
  data_grade: "approved"     #Default: provisional       options: "provisional", "approved".
  export: "no"               #Default: no                options:  "no", "local", "database".
  export_tables: "total"     #Default: total             options: "total", "stratum", "both".
output:
  html_document:
    fig_caption: yes
    theme: default
...
if (exists("creel_estimates")) {
  saveRDS(creel_estimates, file = paste0(here::here(),"/fishery_analyses/", params$project_name, "/", params$fishery_name, "/creel_estimates.R"))
}
#Bring object back in after knit / render. Then proceed to database export as necessary.
#creel_estimates <- readRDS(file = paste0(here::here(),"/fishery_analyses/", params$project_name, "/", params$fishery_name, "/creel_estimates.R"))
```
