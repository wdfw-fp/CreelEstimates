...
ifelse(!dir.exists(paste(here::here(), "project_outputs", sep = "/")),
       {dir.create(paste(here::here(), "project_outputs", sep = "/")); "Output sub-folder created"},
...
ifelse(!dir.exists(paste(wd_output, params$project_name, fishery_name, sep = "/")),
       {dir.create(paste(wd_output, params$project_name, fishery_name, sep = "/")); "Output sub-folder created"},
       "Output sub-folder exists already")
