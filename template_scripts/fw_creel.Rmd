...
ifelse(!dir.exists(paste(wd_output, params$project_name, fishery_name, sep = "/")),
       {dir.create(paste(wd_output, params$project_name, fishery_name, sep = "/")); "project_outputs/project_name/fishery_name analysis sub-folder created"},
