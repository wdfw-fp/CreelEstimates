...
#likely bring intervew_catch object creation up here...?
```
...
#!!Could bring intermediate object creation inline into left_join
#!!leaving for now for clarity pre-review by EB/KB
#!!maybe drop second select() after right_join() if can drop right_join itself?
...
interview_daily_totals <- interview_and_catch |> 
  group_by(time_strata, DayType, section, angler_type, catch_group) |>
