...
renderPlot({
  if(!is.null(pe$interview)) { #creel$interview
    pe$interview |>
      ...
      facet_wrap(~section + angler_type, scales = "free", ncol = 2, labeller = label_wrap_gen(multi_line = F), ncol = 1) 
  }
})
...
renderPlot({
  if(!is.null(pe$interview_and_catch)) { #creel$interview
    pe$interview_and_catch |>
      ...
      facet_wrap(~section + angler_type, scales = "fixed", ncol = 2, labeller = label_wrap_gen(multi_line = F), ncol = 1)
  }
})
