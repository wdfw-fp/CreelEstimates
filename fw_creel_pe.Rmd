...
```{r gt_creel_catch}
creel$catch |> count(catch_group) |> gt(caption = "Total reported encounters in interviews to date")
```
...
```{r chin_jack}
gt_catch("Chinook_Jack|Coho_Jack|Steelhead_Smolt_Steelhead_Unknown")
```
