...
pe$effort_census <- dplyr::left_join(
  ...
  # dplyr::group_by(section, event_date, tie_in_indicator, count_sequence, angler_type, count_census) |>
  # dplyr::summarize(
  #   count_census = sum(count_census)
  # ) |> EB added this to account for multiple categories of bank / boat angler types (e.g., "shore - motorized boat, shore - no boat) in tie-in surveys. These categories were used for Skagit winter steelhead creels and were used in 2022 coastal steelhead
